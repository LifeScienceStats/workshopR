...
::: incremental
-   `%>%` is the pipe operator (part of `magrittr` package)

-   passing the results of the previous operation to the next:
...
![](images/clipboard-2962188991.png)

## Tidy paradigm - pharmaverse

. . .

![](images/clipboard-412081477.png)
...
-   tidy
    ...
    -   or use regular expressions (regex): <https://r4ds.hadley.nz/regexps.html>
:::
