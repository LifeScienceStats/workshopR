...
-   a state that happens when a specific *commit* is checked out instead of a *branch* (you switch to the state of a commit) e.g.: `git checkout 1b18a33`
...
-   instead, if you want to use it as a starting point, create a branch e.g.: `git checkout -b test-branch 1b18a33`
